...
from test_framework.hempycoin_node import HempyCoinTestNode
...
class HempyCoin_ColdStakingTest(HempyCoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(HempyCoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 HYC from the pot)
...
if __name__ == '__main__':
    HempyCoin_ColdStakingTest().main()
