...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/hempycoin-cli.cpp \
           src/hempycoin-tx.cpp \
           src/hempycoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/hempycoin.qrc src/qt/hempycoin_locale.qrc

TRANSLATIONS += src/qt/locale/hempycoin_bg.ts \
                src/qt/locale/hempycoin_de.ts \
                src/qt/locale/hempycoin_en.ts \
                src/qt/locale/hempycoin_es.ts \
                src/qt/locale/hempycoin_fi.ts \
                src/qt/locale/hempycoin_fr.ts \
                src/qt/locale/hempycoin_it.ts \
                src/qt/locale/hempycoin_ja.ts \
                src/qt/locale/hempycoin_pl.ts \
                src/qt/locale/hempycoin_pt.ts \
                src/qt/locale/hempycoin_ru.ts \
                src/qt/locale/hempycoin_sk.ts \
                src/qt/locale/hempycoin_sv.ts \
                src/qt/locale/hempycoin_vi.ts \
                src/qt/locale/hempycoin_zh_CN.ts \
                src/qt/locale/hempycoin_zh_TW.ts
