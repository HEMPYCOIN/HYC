HempyCoin version *3.1.0.2* is now available from:  <https://github.com/HEMPYCOIN/HYC/releases>
...
### Users upgrading to this version are encouraged to also read the detailed release notes for the previous [3.1.0](https://github.com/HEMPYCOIN/HYC/releases/tag/v3.1.0) release as information will not be duplicated here.
