...
The script [extract-osx-sdk.sh](https://github.com/hempycoin-project/hempycoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
hempycoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/hempycoin-project/hempycoin/blob/master/doc/README_osx.md) for troubleshooting tips.
