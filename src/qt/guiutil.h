...
/** Utility functions used by the HempyCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render HempyCoin addresses in monospace font
...
// Parse "hempycoin:" URI into recipient object, return true on successful parsing
