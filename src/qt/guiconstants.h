...
/* HempyCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "HempyCoin"
#define QAPP_ORG_DOMAIN "hempycoin.org"
#define QAPP_APP_NAME_DEFAULT "HempyCoin-Qt"
#define QAPP_APP_NAME_TESTNET "HempyCoin-Qt-testnet"
