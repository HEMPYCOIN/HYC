...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            HempyCoinGUI* window = static_cast<HempyCoinGUI*>(parentWidget());
...
{
    HempyCoinGUI* gui = static_cast<HempyCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<HempyCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("HempyCoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your HYCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
