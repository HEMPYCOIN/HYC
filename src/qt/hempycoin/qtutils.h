...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, HempyCoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, HempyCoinGUI* gui, double posX = 3);
