...
#include "qt/hempycoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/hempycoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(HempyCoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Hempy Coin RPC console.") + "<br>" +
