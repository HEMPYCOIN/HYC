...
#include "qt/hempycoin/settings/settingsnetworkwidget.h"
#include "qt/hempycoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/hempycoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(HempyCoinGUI* _window, QWidget *parent) :
