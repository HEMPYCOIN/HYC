...
#include "qt/hempycoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/hempycoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(HempyCoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to HempyCoinGUI::handleRestart()
