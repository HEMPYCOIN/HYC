...
#include "qt/hempycoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(HempyCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &HempyCoinGUI::openFAQ);
