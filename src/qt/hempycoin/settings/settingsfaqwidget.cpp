...
#include "qt/hempycoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/hempycoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(HempyCoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableHYC,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableHYC,
    ...
    connect(ui->pushButton_UnspendableHYC, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableHYC);});
    ...
    if (parent)
        connect(parent, &HempyCoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
