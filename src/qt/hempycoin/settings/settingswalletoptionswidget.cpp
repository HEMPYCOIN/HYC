...
#include "qt/hempycoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/hempycoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(HempyCoinGUI* _window, QWidget *parent) :
