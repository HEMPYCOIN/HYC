...
#include "qt/hempycoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(HempyCoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("HempyCoin_tx_csv_export(*.csv)") : tr("HempyCoin_addresses_csv_export(*.csv)"),
                                        nullptr);
