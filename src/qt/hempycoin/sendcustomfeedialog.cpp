...
#include "qt/hempycoin/sendcustomfeedialog.h"
#include "qt/hempycoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(HempyCoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &HempyCoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
