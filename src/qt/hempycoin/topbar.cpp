...
#include "qt/hempycoin/topbar.h"
#include "qt/hempycoin/forms/ui_topbar.h"
#include "qt/hempycoin/lockunlock.h"
#include "qt/hempycoin/qtutils.h"
#include "qt/hempycoin/receivedialog.h"
#include "qt/hempycoin/loadingdialog.h"
...
TopBar::TopBar(HempyCoinGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopHyc}, "amount-small-topbar-main");
    setCssProperty({ui->labelAmountHyc}, "amount-topbar");
    setCssProperty({ui->labelPendingHyc, ui->labelImmatureHyc}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Hempy Coin")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // HYC Total
    QString totalHyc = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);

    // HYC
    // Top
    ui->labelAmountTopHyc->setText(totalHyc);
    // Expanded
    ui->labelAmountHyc->setText(totalHyc);
    ui->labelPendingHyc->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
    ui->labelImmatureHyc->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
