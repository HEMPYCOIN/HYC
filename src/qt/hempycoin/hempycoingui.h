...
#include "qt/hempycoin/navmenuwidget.h"
#include "qt/hempycoin/topbar.h"
#include "qt/hempycoin/dashboardwidget.h"
#include "qt/hempycoin/send.h"
#include "qt/hempycoin/receivewidget.h"
#include "qt/hempycoin/addresseswidget.h"
#include "qt/hempycoin/coldstakingwidget.h"
#include "qt/hempycoin/masternodeswidget.h"
#include "qt/hempycoin/snackbar.h"
#include "qt/hempycoin/settings/settingswidget.h"
...
/**
  HempyCoin GUI main class. This class represents the main window of the HempyCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class HempyCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit HempyCoinGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~HempyCoinGUI();
