...
#include "qt/hempycoin/furabstractlistitemdelegate.h"
#include "qt/hempycoin/txviewholder.h"
#include "qt/hempycoin/tooltipmenu.h"
#include "qt/hempycoin/sendmultirow.h"
#include "qt/hempycoin/coldstakingmodel.h"
#include "qt/hempycoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(HempyCoinGUI* parent);
    ~ColdStakingWidget();
