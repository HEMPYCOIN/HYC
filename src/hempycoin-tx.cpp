...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("HempyCoin hempycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hempycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hempycoin transaction") + "\n" +
                               "  hempycoin-tx [options] -create [commands]   " + _("Create hex-encoded hempycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hempycoin transaction
