...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop HempyCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "HempyCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HempyCoin features */
        {"hempycoin", "listmasternodes", &listmasternodes, true },
        {"hempycoin", "getmasternodecount", &getmasternodecount, true },
        {"hempycoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"hempycoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"hempycoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"hempycoin", "masternodecurrent", &masternodecurrent, true },
        {"hempycoin", "startmasternode", &startmasternode, true },
        {"hempycoin", "createmasternodekey", &createmasternodekey, true },
        {"hempycoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"hempycoin", "listmasternodeconf", &listmasternodeconf, true },
        {"hempycoin", "getmasternodestatus", &getmasternodestatus, true },
        {"hempycoin", "getmasternodewinners", &getmasternodewinners, true },
        {"hempycoin", "getmasternodescores", &getmasternodescores, true },
        {"hempycoin", "preparebudget", &preparebudget, true },
        {"hempycoin", "submitbudget", &submitbudget, true },
        {"hempycoin", "mnbudgetvote", &mnbudgetvote, true },
        {"hempycoin", "getbudgetvotes", &getbudgetvotes, true },
        {"hempycoin", "getnextsuperblock", &getnextsuperblock, true },
        {"hempycoin", "getbudgetprojection", &getbudgetprojection, true },
        {"hempycoin", "getbudgetinfo", &getbudgetinfo, true },
        {"hempycoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"hempycoin", "mnfinalbudget", &mnfinalbudget, true },
        {"hempycoin", "checkbudgets", &checkbudgets, true },
        {"hempycoin", "mnsync", &mnsync, true },
        {"hempycoin", "spork", &spork, true },
...
{
    return "> hempycoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2815/\n";
}
