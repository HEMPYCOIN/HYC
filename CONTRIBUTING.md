Contributing to HempyCoin
============================

The HempyCoin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/hempycoin-project/hempycoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the HempyCoin project, and is not to be
confused with overall HempyCoin Network Protocol consensus changes.

Whether a pull request is merged into HempyCoin rests with the project merge
...
Patches that change HempyCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the HempyCoin consensus, it must have been
...
The project leader is the release manager for each HempyCoin release.
